...
__export(index_exports, {
  ...
  AxAIHuggingFaceModel: () => AxAIHuggingFaceModel,
  AxAIMistral: () => AxAIMistral,
  ...
  AxDB: () => AxDB,
  AxDBBase: () => AxDBBase,
  AxDBCloudflare: () => AxDBCloudflare,
  AxDBManager: () => AxDBManager,
...
var TextDecoderStreamPolyfill = class extends import_web2.TransformStream {
  constructor() {
...
var AxApacheTika = class {
  ...
  async _convert(file, options) {
    const fileData = typeof file === "string" ? (0, import_node_fs.createReadStream)(file) : file.stream();
    if (!fileData) {
